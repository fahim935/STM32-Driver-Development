/*******************************************************************************
 * @file           i2c_slv_irq_tx_rx_large_data.c
...
#if (FEATURE_SELECTED == STM32_I2C_SLV_IRQ_TX_RX_LARGE_DATA)
#include "common.h"
...
uint8_t Tx_buf[]  =   "\nSTM32F407 Slave Test Payload\n"
                      "Hello master — this is a long test string\n"
                      ...
                      "Hope you receive all the data 123";
...
void i2c_slv_irq_tx_rx_large_data_testing(void){
